...
import kotlinLabExec.ClassLoaders.ExtensionClassLoader;
import kotlinLabExec.gui.*;
...
{  
   ...
   static public   String  dateOfBuild = "20-July-22";       // tracks the date of build
    static public Shell kshell;
    static public KotlinCompleter kcompleter;
    // static public KJvmReplCompilerWithIdeServices kcompiler = new KJvmReplCompilerWithIdeServices();
   // static public KotlinCompleter kcompleter = new KotlinCompleter(kcompiler);
   ...
   // static public KotlinJsr223JvmScriptEngineBase jsrKotlinEngine;
 ...
 // variables for implementing code completion using Java reflection
   ...
   static public boolean pathUpdateOnSaves = false;
    ...
    static public int maxNumsOutputToString = 1000;  // restricts output of toString()
        ...
        static public  java.util.LinkedList<String>  kotlinLabShellPathsList = null;  // the current paths list with which the JShell's classloader is inited
        ...
        "import kotlin.jvm.*"
          ...
          static public String [] jshellBasicGlobalImports={
                  ...
                  "import static kotlinLabSci.math.array.Vec.*; ",
        
                    "import kotlinLabSci.math.array.Matrix; ",  // Matrix class

                  "import static kotlinLabSci.math.array.Matrix.*; ",
                    "import kotlinLabSci.math.array.Mat1D; ",  // Matrix class
                    "import static kotlinLabSci.math.array.Mat1D.*; ",  // Matrix class
                    
                    "import  static  kotlinLabSci.math.array.DoubleArray.*;  ",
                
                    "import kotlinLabSci.math.array.CCMatrix; ",  // Matrix class
                    "import static kotlinLabSci.math.array.CCMatrix.*; ",  
                    "import kotlinLabSci.math.array.Sparse; ",  // Sparse Matrix class
                    "import static kotlinLabSci.math.array.Sparse.*; ",  
                    "import kotlinLabSci.math.array.JILapack; ",  // JLapack Matrix class
                     "import static kotlinLabSci.math.array.JILapack.*; ",  
                     "import Jama.*;",
                     "import static kotlinLabSci.math.plot.plot.*;  ",     // plotting routines 
                     "import static kotlinLabSciCommands.BasicCommands.*;   ",
    
                      "import static kotlinLabSci.math.array.MatrixConvs.*;   ", 
                  ...
                  "import static JFreePlot.jPlot.*;  ",
                   ...
                   "import static java.util.stream.Collectors.*;",
                    ...
                    "import java.text.DecimalFormat;   ",
                     ...
                     "import static kotlinLabSci.FFT.ApacheFFT.*;  ",
                     "import static kotlinLabSci.FFT.FFTCommon.*;  ", 
  ...
  static public DataOutputStream     writer = null;
   ...
   // codes for kotlinLab server computations
    ...
    static public String buildTitle() {
      ...
      String mainFrameTitle =        "kotlinLab based on Kotlin and JShell "+ ", Kotlin version ="+ KotlinVersion.CURRENT+
    ...
    public static void initKotlinShell() {
 var cp=       GlobalValues.kshell.getCompilationConfiguration().toString();

      System.out.println("cp = "+cp);
        // kcompleter
        //var completer = GlobalValues.kshell.getCompleter();
        //settings.SOS
    }
    public static void initKotlinEngine() {

        if (GlobalValues.extensionClassLoader==null)
            JOptionPane.showMessageDialog(null, "extension ClassLoader null!!");
    ...
    // since we have created the Kotlin script path, we can create the KShell also, that will utilize that path
        GlobalValues.kshell = new KShell().createShell();
        GlobalValues.kshell.initEngine();

        GlobalValues.kcompleter = GlobalValues.kshell.getCompleter();

        Thread.currentThread().setContextClassLoader(GlobalValues.jshell.getClass().getClassLoader());
    ...
    public GlobalValues()
    {
           extensionClassLoader = new  ExtensionClassLoader("", Thread.currentThread().getContextClassLoader());
