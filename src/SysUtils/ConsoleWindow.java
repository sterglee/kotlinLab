     ...
     output.setToolTipText("Displays Java's output sent at System.out stream and messages produced from Java's runtime exceptions");
      ...
      int locY = 0; //loc.y;
        ...
        // output.setLineWrap( true );
         ...
         output.setToolTipText("F5 clears this window. Displays the program output redirecting the System.out.print(), System.err.print(), System.out.println() etc commands");
         ...
         consoleStream = new PrintStream( new OutputStream () {
            @Override
                ...
                { 
                    if (len > GlobalValues.mxLenToDisplay)
                        len = GlobalValues.mxLenToDisplay;
      ...
      public void  updateCaret()  {
         int pos = totalLength-1;
          ...
          if (GlobalValues.gLabMainFrame !=null) {
           int xSize = GlobalValues.globalEditorPane.getSize().width;
