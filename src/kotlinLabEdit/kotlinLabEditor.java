...
public class kotlinLabEditor extends JFrame implements WindowListener {
    ...
    public static String titleStr = "KotlinLab programmer's editor (F6 - Kotlin,  F7 - JShell) "+ GlobalValues.TITLE;
...
// update fields denoting the document in the editor, necessary when a new document is edited
  public  RSyntaxDocument updateDocument()  {
   ...
   public  String   getSelectedTextOrCurrentLine() {
    ...
    public RSyntaxTextArea  commonEditingActions(String selectedValue, boolean isMainFrame) {
        ...
        jep.setToolTipText("F6 for Kotlin and F7 for JShell executes selected text or current line. F3 supplies completion info. F5 clears console window");
 ...
 KotlinMenu.setFont(GlobalValues.uifont);
                  ...
                  JMenuItem executeWithKotlinJMenuItem = new JMenuItem("Execute Code with Kotlin (use also F6 key");
 ...
 JShellMenu.setFont(GlobalValues.uifont);
           ...
           variablesOfJShellJMenuItem.setFont(GlobalValues.puifont);
           ...
           importsOfJShellJMenuItem.setFont(GlobalValues.puifont);
           ...
           bindingOfJShellJMenuItem.setFont(GlobalValues.puifont);
        ...
        JMenuItem methodsOfJShellJMenuItem = new JMenuItem("Display JShell's methods");
           String [] allMethods = new String[100];
            ...
            methodsOfJShellJMenuItem.setFont(GlobalValues.puifont);
           methodsOfJShellJMenuItem.addActionListener((ActionEvent e) -> {
            ...
            JList resultsList= new JList(allMethods);
               ...
               controlCharsToDisplayMenuItem.setFont(GlobalValues.guifont);
...
//  importsMenu.add(apacheCommonMathImportJMenuItem);
      ...
      JMenuItem nrMenuItem = new JMenuItem("Numerical Recipes ");
        ...
        JMenuItem kotlinLabSciPlotsExamplesHelpJTreeJMenuItem  = new JMenuItem("kotlinLabSci Plotting Examples with JTree format ");
        kotlinLabSciPlotsExamplesHelpJTreeJMenuItem.setFont(GlobalValues.uifont);
        kotlinLabSciPlotsExamplesHelpJTreeJMenuItem.addActionListener(new kotlinLabSciPlotExamplesJTreeAction());
        kotlinLabSciPlotsExamplesHelpJTreeJMenuItem.setToolTipText("Provides examples of kotlinLabSci plotting scripts with a convenient JTree displaying. To execute Copy and Paste in editor");
...
//kotlinLabSciExamplesHelpJMenuItem.setIcon(new ImageIcon(groovyImage));
        ...
        JMenuItem kotlinLabSciPlotsExamplesJMenuItem  = new JMenuItem("kotlinLabSci Plot Examples ");
        kotlinLabSciPlotsExamplesJMenuItem.setFont(GlobalValues.uifont);
        kotlinLabSciPlotsExamplesJMenuItem.addActionListener(new kotlinLabSciPlotExamplesJTreeAction());
        kotlinLabSciPlotsExamplesJMenuItem.setToolTipText("Provides examples of kotlinLabSci Plot scripts. To execute Copy and Paste in editor");
        
 
        
        examplesMenu.add(kotlinLabSciExamplesHelpJMenuItem);
        examplesMenu.add(jShellLabSciExamplesHelpJMenuItem);
         examplesMenu.add(kotlinLabSciPlotsExamplesJMenuItem);
        examplesMenu.add(kotlinLabSciExamplesHelpJTreeJMenuItem);
        examplesMenu.add(kotlinLabSciPlotsExamplesHelpJTreeJMenuItem);
    ...
    classpathMenu.setToolTipText("Classpath control of JShell");
       ...
       JMenuItem appendClassPathJMenuItem = new JMenuItem("pattern of code to append to classpath of JShell a jar file ");
        ...
        appendClassPathJMenuItem.addActionListener((ActionEvent e) -> { 
            suggestionField.setText(" kotlinLabGlobal.Interpreter.GlobalValues.jshell.addToClasspath( <your jar file here!>);"); 
        });
